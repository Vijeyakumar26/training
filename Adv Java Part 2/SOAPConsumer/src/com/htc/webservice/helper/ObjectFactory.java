...
public class ObjectFactory {
    ...
    private final static QName _GetAllTouristPlaces_QNAME = new QName("http://webservice.htc.com/", "getAllTouristPlaces");
    private final static QName _GetAllTouristPlacesResponse_QNAME = new QName("http://webservice.htc.com/", "getAllTouristPlacesResponse");
    private final static QName _GetTouristPlaceDetailsResponse_QNAME = new QName("http://webservice.htc.com/", "getTouristPlaceDetailsResponse");
    private final static QName _GetTouristPlaceDetails_QNAME = new QName("http://webservice.htc.com/", "getTouristPlaceDetails");
     ...
     * 
     */
    @XmlElementDecl(namespace = "http://webservice.htc.com/", name = "getAllTouristPlaces")
     ...
     * 
     */
    @XmlElementDecl(namespace = "http://webservice.htc.com/", name = "getAllTouristPlacesResponse")
     ...
     * 
     */
    @XmlElementDecl(namespace = "http://webservice.htc.com/", name = "getTouristPlaceDetailsResponse")
     ...
     * 
     */
    @XmlElementDecl(namespace = "http://webservice.htc.com/", name = "getTouristPlaceDetails")
